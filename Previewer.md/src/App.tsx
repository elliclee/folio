...
import { Download, Copy, FileText, Check, LayoutPanelLeft, Palette, FolderOpen, FolderPlus, Columns, Maximize, PanelLeft, Save, ChevronDown, ChevronRight, ChevronUp, Folder, SquareTerminal, X, Search } from 'lucide-react';
      ...
      return (
        <div key={node.path}>
          <button
            ...
            className="flex h-7 w-full items-center gap-1.5 rounded-sm py-1 pr-2 text-left text-[13px] leading-none text-secondary transition-colors hover:bg-btn-hover hover:text-primary"
